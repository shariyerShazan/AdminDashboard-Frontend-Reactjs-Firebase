...
const CommonPagination = ({ currentPage, totalPages, onPageChange }: Props) => {
  return (
    <div className="flex items-center justify-between w-full my-3 px-2">
      ...
      <div className="text-sm hidden sm:block font-medium text-slate-500 bg-slate-50 px-4 py-2 rounded-full border border-slate-100">
        Showing Page{" "}
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1  p-2 cursor-pointer text-sm font-semibold rounded-xl border bg-[#00C853] text-white hover:bg-[#02b04b] shadow-md shadow-blue-100 disabled:opacity-50 transition-all active:scale-95"
        >
